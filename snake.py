...
# Keyborrd
window1.listen()
window1.onkeypress(go_up,"Up")
window1.onkeypress(go_down,"Down")
window1.onkeypress(go_left,"Left")
window1.onkeypress(go_right,"Right")
...
while True:
    ...
    if snake.distance (food) < 20:
        ...
        winsound.PlaySound("snakehit.wav", winsound.SND_ASYNC)
